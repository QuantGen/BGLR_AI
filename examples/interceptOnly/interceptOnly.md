...
$$y=1\mu+X_1\beta_1+X_2\beta_2+...+u_1+u_2+...+\varepsilon$$
...
The terms of the linear predictor ($X_1\beta_1+X_2\beta_2+...+u_1+u_2$) are specified through the argument `ETA`, when this term is not included in the model, by default, BGLR fits an intercept model of the form
