...
| [fixedEffects.md](examples/fixedEffects/fixedEffects.md) | <ul><li> Linear regression w/factors and covariates</li><li>  Posterior means and posterior SD</li><li>  Trace plots</li><li> Posterior density plots</li><li> Posterior credibility regions</li><li> Posterior (co)variance of estimates </li></ul> | [wages](https://github.com/QuantGen/BGLR_AI/blob/main/DATA/wages.txt) |None | TBR |
